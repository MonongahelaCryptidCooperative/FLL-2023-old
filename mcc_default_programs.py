...
def straight_1000mm(bot:Robot):
    """Code to Calibrate Movement Wheel Size. Drives 1 meter.
     If too short decrease wheel diameter.
      If too long increase wheel diameter"""
...
def light_sample(bot:PrimeRobot):
    ...
    while drive_base.distance() < 500:
        left_light = bot.left_light.reflection()
        right_light = bot.right_light.reflection()
    ...
    print("Threshold: ", (((max_right + max_left)/2 - 10) +
     ((min_left + min_right)/2 + 10))/2)
    drive_base.stop()
